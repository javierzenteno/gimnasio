...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        setEllipsis: function () {
            var self = this, $capCont = self.$captionContainer, $cap = self.$caption,
                $ellipsis = $capCont.find('.file-caption-ellipsis'), 
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>. Por favor vuelva a subir!',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>. Por favor vuelva a subir!',
        ...
        msgInvalidFileExtension: 'Invalid extension for file "{name}". Solamente extensiones "{extensions}" soporta.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Error al subir archivo</span>',
