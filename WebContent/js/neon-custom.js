...
function btn_modificar(id,tipo,num){
	return '<button class="btn btn-xs btn-primary '+(tipo?'btn-icon icon-left':'')+' modificar'+num+'"  data-toggle="tooltip" data-placement="top" title="Modificar" data-id="'+id+'"><i class="entypo-pencil"></i>'+(tipo?'Modificar':'')+'</button>';
}
function btn_imprimir(id,tipo){
	return '<button class="btn btn-xs btn-success '+(tipo?'btn-icon icon-left':'')+' imprimir"  data-toggle="tooltip" data-placement="top" title="Imprimir" data-id="'+id+'"><i class="entypo-print"></i>'+(tipo?'Imprimir':'')+'</button>';
}
function btn_darestado(id,tipo,estado,num){
	return '<button class="btn btn-xs btn-'+(estado?'info':'danger')+' '+(tipo?'btn-icon icon-left':'')+' darestado'+num+'"  data-toggle="tooltip" data-placement="top" title="'+(estado?'Activar':'Eliminar')+'" data-estado="'+estado+'" data-id="'+id+'"><i class="entypo-thumbs-'+(estado?'up':'down')+'"></i>'+(estado?((tipo?'Activar':'')):(tipo?'Eliminar':''))+'</button>';
}
function btn_asignar(id,tipo){
	return '<button class="btn btn-xs btn-warning '+(tipo?'btn-icon icon-left':'')+' asignar"  data-toggle="tooltip" data-placement="top" title="Asignar" data-id="'+id+'"><i class="entypo-reply-all"></i>'+(tipo?'Asignar':'')+'</button>';
}
function btn_configure(color,clase,title,id,icono,texto,tipo){
	return '<button class="btn btn-xs btn-'+color+' '+(tipo?'btn-icon icon-left':'')+' '+clase+'"  data-toggle="tooltip" data-placement="top" title="'+title+'" data-id="'+id+'"><i class="'+icono+'"></i>'+texto+'</button>';
}
